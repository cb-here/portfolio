  ...
  const projects = [
    {
      ...
      status: "Deployed",
      liveUrl: "https://noter-new.vercel.app/",
      githubUrl: "https://github.com/cb-here/noter-new",
      tags: ["React", "TypeScript", "Vercel", "Node", "Express"],
    },
    {
      title: "Quickserve",
      description:
        "Restaurant management platform with real-time ordering system",
      status: "Deployed",
    ...
    },
    {
      ...
      description:
        "Personalized learning roadmap generator with progress tracking",
      status: "Deployed",
